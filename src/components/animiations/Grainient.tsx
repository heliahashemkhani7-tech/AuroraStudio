...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    const updateUniforms = () => {
      ...
      // Colors
      u.uColor1.value = new Float32Array(colorToRgb(color1));
      u.uColor2.value = new Float32Array(colorToRgb(color2));
      u.uColor3.value = new Float32Array(colorToRgb(color3));
    };

    // اولین اجرا
    updateUniforms();

    // تشخیص تغییر Dark / Light
