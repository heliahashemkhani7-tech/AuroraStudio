...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-[1em] left-1/2 -translate-x-1/2 z-[1000] w-full">
      <Container>
        <nav
          dir="ltr"
          className={`flex backdrop-blur-xl border border-white/20 shadow-lg rounded-full  justify-between  ${className}`}
          style={{
            ...cssVars,
            background: "var(--base)",
          }}
